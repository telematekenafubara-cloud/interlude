...
var grokOgIdentity = { "site": {
	...
	"card": "custom",
	"color": "0b0b0a",
	"description": "The wait is the inventory. A Hold plays while an AI thinks, then the answer arrives.",
	"image": "/og.jpg",
	"banner": "/x-banner.jpg"
} };
//#endregion
...
var findRouteRules = /* @__PURE__ */ (() => {
	...
	return (m, p) => {
		...
		if (p === "/og.jpg") r.unshift({ data: $0 });
		else if (p === "/x-banner.jpg") r.unshift({ data: $1 });
		let s = p.split("/");
		if (s.length > 1) {
