...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DIhQCW8d.mjs");
...
var manifest = { "c934df3e526f3570e1a7f17300945b14fae992187bb6e4db2e6e1e69bcb3fd24": {
	functionName: "askGrok_createServerFn_handler",
	importer: () => import("./ask-grok-C6Qv655d.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B0-yeu4t.mjs").then((n) => n.t),
